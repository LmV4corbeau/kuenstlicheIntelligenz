...
\title{Welche Topologie ist für ein einschichtige KNN in diesem Problem besonders geeignet?}
\subtitle{KNN Topologien}
\author[Tom Schumann]{Tom Schumann}
\institute{University of Applied Sciences Zittau/Görlitz}
\date[DD\,/\,MM\,/\,JJJJ]{13\textsuperscript{th}~11~2015}
...
\frametitle{Gliederung}
  \begin{columns}
   ...
   \hspace*{-1.3cm}
   \begin{column}{4.0cm}
		\includegraphics[width=3.5cm]{images/fragen.png}
   \end{column}
  \end{columns}
\end{frame}
\section[FeaturVektor]{FeaturVektor}
\begin{frame}{FeaturVektor}{Verwendete Eigenschaften}
\begin{itemize}
	\item RED\_AND\_BLACK
	\item MAX\_RED\_PART\_IN\_HORIZONTAL\_PART
	\item WHITE\_PART\_IN\_PICTURE\_TO\_RED
	\item MAX\_WHITE\_PART\_TO\_BLUE\_IN\_QUADRANT
	\item MAX\_COLOR\_WITHOUT\_WHITE
	\item PIXELCOUNT
	\item BLUECOUNT
	\item YELLOWCOUNT
	\item REDCOUNT
...
\begin{frame}{Netztopologie}{Ein Perzeptron für ein Konzept}
\includegraphics[scale=0.45]{images/vORFAHRTGEW.png}\\
\end{frame}

\begin{frame}{Netztopologie}{Binärcodierung der Konzept}
